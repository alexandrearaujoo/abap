  ...
  return (
    <Section>
      ...
      <h2>Informações do pagamento</h2>
        ...
        <InputDefault width='90%' value={infoPagamento.createdAt} disabled={true} label='Data de pagamento'/>
        <Div>
        <InputDefault width='65%'value={infoPagamento.status} disabled={true} label='Status'/>
