        ...
        <StyledSection>
          ...
          <article>
            <p>
              Membro desde:{" "}
              <span>
                {adm.createdAt.slice(0, 10).split("-").reverse().join("/")}
              </span>
            </p>
            <p>
              Estado: <span>{adm.estado}</span>
            </p>
            <p>
              Cidade: <span>{adm.cidade}</span>
            </p>
            <p>
              Bairro: <span>{adm.bairro}</span>
            </p>
            <p>
              Endereço: <span>{adm.endereco}</span>
            </p>
          </article>
